...
function CheckGenero(){
	if (ExUnits == 1 && ExType == 2  || ExUnits == 9 && ExType == 1 || ExUnits == 19 && ExType == 1) {
		console.log("tipo3");
		ExGenero = "3r";
	}
		...
		ExGenero = "4r";
		    ...
		    || ExUnits == 11 && ExType == 1 || ExUnits == 11 && ExType == 2){
...
//Intermedios
	...
	else if (currentex == '19 1 0') {show = 'Synonym for: step <br><button class="ogspace2">?</button>.'; r1 = 'box'; r2='foot'; r3='footstep'}
	else if (currentex == '19 1 1') {show = 'Synonym for: storm <br><button class="ogspace2">?</button>.'; r1 = 'explosion'; r2='tornado'; r3='lightning'}
	else if (currentex == '19 1 2') {show = 'Synonym for: strange <br><button class="ogspace2">?</button>.'; r1 = 'bizarre'; r2='unique'; r3='special'}
	else if (currentex == '19 1 3') {show = 'Synonym for: strenght <br><button class="ogspace2">?</button>.'; r1 = 'force'; r2='weak'; r3='fragile'}
	else if (currentex == '19 1 4') {show = 'Synonym for: stripe <br><button class="ogspace2">?</button>.'; r1 = 'round'; r2='triangle'; r3='line'}
	else if (currentex == '19 1 5') {show = 'Synonym for: stubborn <br><button class="ogspace2">?</button>.'; r1 = 'obstinate'; r2='flexible'; r3='movable'}
	else if (currentex == '19 1 6') {show = 'Synonym for: superior <br><button class="ogspace2">?</button>.'; r1 = 'inferior'; r2='greater'; r3='lower'}
	else if (currentex == '19 1 7') {show = 'Synonym for: taste <br><button class="ogspace2">?</button>.'; r1 = 'flavor'; r2='unflavored'; r3='unsavory'}
	else if (currentex == '19 1 8') {show = 'Synonym for: summary <br><button class="ogspace2">?</button>.'; r1 = 'extension'; r2='comprehensive'; r3='synopsis'}
	else if (currentex == '19 1 9') {show = 'Synonym for: suggestion <br><button class="ogspace2">?</button>.'; r1 = 'opinion'; r2='warning'; r3='advertisement'}
	...
	unit19answers1=["bruh","step - footstep","storm - tornado","strange - bizarre","stripe - line","stubborn - obstinate","superior - greater","taste - flavor","summary - synopsis","suggestion - opinion"];
	
	unit19answers2=["bruh","footstep","tornado","bizarre","line","obstinate","greater","flavor","synopsis","opinion"];
...
checkFrase();
	if (ExcerciseNo == 10) {
		...
		getExcercise.innerHTML =   '<div><img class="oggreenred" src="imgs/'+listadecorrects[0]+'.png"> <p class="oganswer"> 1. '+listaderespuestas[0]+'</p> </div>'+
			...
			if (ExUnits == 12 || ExUnits == 16) {
					getBotEnd.innerHTML =	'';
					removeButton.innerHTML = '<div class="ogbox3"><button id="ogdiss2" onclick="Calificar();" class="fluid ui blue button">Next1</button></div>';
			}
