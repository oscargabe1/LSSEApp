!function (e, t) {
    ...
    var e = {
        ...
        o = t(["success", "warning", "info", "question", "error"]), r = function (e, t) {
            ...
            return n
        }, i = {previousWindowKeyDown: null, previousActiveElement: null, previousBodyPadding: null}, a = function (e) {
            ...
            var r = u(), i = B(r, n.input), a = B(r, n.file), s = r.querySelector("." + n.range + " input"),
                c = r.querySelector("." + n.range + " output"), d = B(r, n.select),
                p = r.querySelector("." + n.checkbox + " input"), f = B(r, n.textarea);
        ...
        s = function () {
            ...
            var l = p(), s = f(), d = g(), y = b(), C = w();
            if (t.titleText ? l.innerText = t.titleText : l.innerHTML = t.title.split("\n").join("<br>"), t.text || t.html) {
                if ("object" === N(t.html)) if (s.innerHTML = "", 0 in t.html) for (var k = 0; k in t.html; k++) s.appendChild(t.html[k].cloneNode(!0)); else s.appendChild(t.html.cloneNode(!0)); else t.html ? s.innerHTML = t.html : t.text && (s.textContent = t.text);
                A(s)
            } else P(s);
            t.showCloseButton ? A(C) : P(C), r.className = n.modal, t.customClass && S(r, t.customClass);
            var x = h(), B = parseInt(null === t.currentProgressStep ? $.getQueueStep() : t.currentProgressStep, 10);
            ...
            return new Promise(function (t, o) {
                ...
                for (var T = function (n) {
                    ...
                    var n = t || window.event, i = n.target || n.srcElement, a = g(), s = b(), u = a === i || a.contains(i),
                        c = s === i || s.contains(i);
                    switch (n.type) {
                        case"mouseover":
                        case"mouseup":
                        ...
                        case"mousedown":
                            ...
                            break;
                        case"click":
                            if (u && e.isVisible()) if (e.disableButtons(), l.input) {
                                var d = k();
                            ...
                            } else T(!0); else c && e.isVisible() && (e.disableButtons(), e.closeModal(l.onClose), o("cancel"))
                    }
                ...
                var K = function (e, t) {
                    ...
                    var n = t || window.event, r = n.keyCode || n.which;
                    if ([9, 13, 32, 27].indexOf(r) !== -1) {
                        for (var i = n.target || n.srcElement, a = C(l.focusCancel), s = -1, u = 0; u < a.length; u++) if (i === a[u]) {
                            s = u;
                            break
                        }
                ...
                switch (l.input) {
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var G = B(d, n.range), ee = G.querySelector("input"), te = G.querySelector("output");
                    ...
                    case"radio":
                        ...
                        break;
                    case"checkbox":
                        var ie = B(d, n.checkbox), ae = a("checkbox");
